...
public class YamlConfig implements Configuration {
    ...
    private void load() {
        ...
        try {
            ...
            FunctionalLibAPI.getAPI().orElseThrow(NullPointerException::new).getLogger().error("Ошибка загрузки конфига: {}", configFile.getName(), e);
        }
    }
    ...
    public void save(File file) {
        try {
            ...
            FunctionalLibAPI.getAPI().orElseThrow(NullPointerException::new).getLogger().error("Ошибка при сохранении конфигурации", e);
        }
    }
